...
sns.set_style("whitegrid")
sns.set_palette("ch:s=.25,rot=-.25")
sns.lineplot(x='team', y='average_points', data=average_points_data_frame)
plt.xticks(rotation=45, ha='right', fontsize=10)
plt.title("Average Point Simulations for Teams", fontsize=16)
plt.xlabel("Teams", fontsize=12)
plt.ylabel("Simulated Points", fontsize=12)
plt.grid(True, axis='y', linestyle='--', alpha=0.7)
plt.tight_layout()
